...
<head>
    ...
    <style>
        ...
        .sidebar {
            width: 250px;
            background: #2c3e50; /* Ajustement de la couleur de fond */
            color: #ecf0f1;
            padding: 20px;
            position: sticky;
            top: 0;
        ...
        .sidebar h2 {
            ...
            margin: 20px 0 15px;
            padding-bottom: 10px;
            border-bottom: 1px solid #34495e; /* Bordure plus fine */
            color: #ecf0f1; /* Couleur de texte plus claire */
            font-weight: 600; /* Police moins grasse */
        }
        .sidebar ul { list-style: none; padding: 0; margin: 0 0 25px; /* Plus d'espace en bas */ }
        ...
        .sidebar a.active {
            background: #3498db; /* Couleur bleue pour le lien actif */
            color: white;
            font-weight: 600;
        }
        .sidebar i { margin-right: 10px; width: 20px; text-align: center; }
        .content { flex: 1; padding: 20px; background: #fff; max-width: 800px; margin: 0 auto; }
        ...
        .problem-status-indicator{width:10px;height:10px;border-radius:50%;margin-right:8px;display:inline-block}
...
<body>
    <div class="main-container">
        <!-- Inclusion du fichier sidebar.php -->
                ...
                <div class="publication-card">
                    ...
                    <div class="publication-footer">
                        ...
                        <div class="action-buttons">
                            ...
                            <a href="submit_solution.php?problem_id=<?= $pub['problem_id'] ?>" 
