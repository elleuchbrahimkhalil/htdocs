            ...
            <form method="POST" action="process_solution.php" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    <div class="code-editor-container">
                        <!-- Inside the form, after code-editor-container -->
<div class="explanation-container">
    <h3><i class="fas fa-comment-alt"></i> Explication de la solution</h3>
    <textarea 
        name="explanation" 
        class="explanation-text" 
        placeholder="Expliquez votre approche et la logique derrière votre solution..."
    ></textarea>
</div>

<div class="price-container">
    <h3><i class="fas fa-tag"></i> Prix proposé</h3>
