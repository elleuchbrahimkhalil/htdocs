...
try {
    ...
    // Dans edit_solution.php, avant de traiter le formulaire
    if ($solution['status'] === 'accepted' && !empty($solution['payment_id'])) {
        $_SESSION['error_message'] = "Vous ne pouvez pas modifier une solution qui a déjà été acceptée et payée.";
        header('Location: dashboard.php');
        exit;
    }
