...
if ($problem_id <= 0) {
    ...
    try {
        ...
        if (!$pdo) {
            ...
            $tables = $pdo->query("SHOW TABLES LIKE 'problems'")->fetchAll();
            if (count($tables) === 0) {
                ...
                $columns = $pdo->query("SHOW COLUMNS FROM problems")->fetchAll(PDO::FETCH_COLUMN);
        ...
        // Capture spécifique des erreurs PDO
