...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            background: #34495e; /* Couleur de fond plus foncée */
            color: #ecf0f1;
            padding: 20px; /* Plus d'espace intérieur */
            position: sticky;
            top: 0;
            height: 100vh;
            box-shadow: 2px 0 5px rgba(0, 0, 0, 0.1); /* Ajoute une ombre */
        }
        .sidebar h2 {
            font-size: 1.3em; /* Taille de police légèrement augmentée */
            margin: 20px 0 15px;
            padding-bottom: 10px;
            border-bottom: 2px solid #2c3e50; /* Bordure plus épaisse */
        }
        ...
        .sidebar a:hover {
            background: #2c3e50; /* Couleur de survol */
            color: #fff;
            transform: translateX(5px); /* Déplacement plus visible */
        }
