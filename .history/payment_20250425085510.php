...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof google !== 'undefined' && google.payments && google.payments.api) {
        ...
        console.warn("Google Pay not available, skipping initialization");
        // Hide Google Pay elements
        document.querySelectorAll('.payment-method[data-method="google_pay"]').forEach(function(el) {
