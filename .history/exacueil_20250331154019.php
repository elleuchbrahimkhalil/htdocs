...
<body>
    ...
    <div class="publications-grid" style="display: flex; flex-wrap: wrap; gap: 20px;">

                <?php foreach ($publications as $pub): ?>
        <div class="publication-card" style="flex: 1 1 calc(33.333% - 20px);">

            <button class="favorite-btn <?= $pub['is_favorite'] ? 'active' : '' ?>" style="position: absolute; top: 15px; right: 15px;">
            ...
            <div class="publication-footer" style="display: flex; justify-content: space-between;">
