    ...
    <div class="solution-form">
        <form method="POST" action="process_solution.php">
            ...
            <div class="price-container">
                ...
                <input type="number" id="price" name="price" class="price-input" min="1" step="0.01" placeholder="0.00 €" value="<?php echo isset($solution['price']) ? htmlspecialchars($solution['price']) : ''; ?>" required>
