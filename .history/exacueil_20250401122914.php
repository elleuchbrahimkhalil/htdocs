...
<head>
    ...
    <style>
        ...
        /* Modification: Changement de la grille à un format horizontal */
        .publications-grid {
            display: flex;
            flex-direction: column;
            gap: 25px;
        ...
        /* Modification: Carte horizontale au lieu de verticale */
        .publication-card {
        ...
        /* Modification: Changement de l'icône de favori */
        .favorite-btn {
            cursor: pointer;
            font-size: 1.4em;
            background: none;
