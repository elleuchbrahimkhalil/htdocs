            ...
            if (submitBtn && !submitBtn.disabled) {
                ...
                setTimeout(() => {
                    ...
                    if (isAccept) {
                        ...
                        // Forcer la redirection côté client après un court délai pour éviter blocage JS
                        setTimeout(() => {
                            const solutionId = form.querySelector('input[name=\"solution_id\"]').value;
                            window.location.href = 'payment.php?solution_id=' + solutionId + '" . ($debug_mode ? " + '&debug=1'" : "") . ";
                        }, 500);
                    } else {
