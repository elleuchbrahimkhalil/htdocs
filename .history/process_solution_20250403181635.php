...
try {
    ...
    // Puis insérer la solution avec la référence au prix
    $stmt = $pdo->prepare("
        INSERT INTO solutions (problem_id, user_id, solution_code, explanation, status, price_id)
        VALUES (?, ?, ?, ?, 'pending', ?)
    ");
