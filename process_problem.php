...
error_log("Tentative d'insertion du problème: " . json_encode($data)); // Log attempt to insert problem
...
try {
    ...
    if ($result) {
        ...
        error_log("Problème inséré avec succès, ID: " . $problem_id); // Log successful insertion
